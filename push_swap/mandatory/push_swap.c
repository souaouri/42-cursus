...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/04/02 07:29:54 by souaouri          #+#    #+#             */
/*   Updated: 2024/05/09 20:15:11 by souaouri         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	main(int argc, char **argv)
{
	...
	while (++var.i <= argc - 1)
	{
		...
		while (spliter[var.j])
		{
			...
			ft_lstadd_back(&stack_a, ft_lstnew(var.num));
			var.j++;
		}
		freee(spliter);
	}
	is_frequent(stack_a);
	shose_sort(argc, &stack_a, &stack_b);
}
